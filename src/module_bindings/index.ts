...
import HawkRow from "./hawk_table";
import KillFeedRow from "./kill_feed_table";
...
const tablesSchema = __schema({
  hawk: __table({
    name: 'hawk',
    indexes: [
      { accessor: 'id', name: 'hawk_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
    ],
    constraints: [
      { name: 'hawk_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, HawkRow),
  killFeed: __table({
    name: 'kill_feed',
    indexes: [
      { accessor: 'id', name: 'kill_feed_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
    ],
    constraints: [
      { name: 'kill_feed_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, KillFeedRow),
  player: __table({
    name: 'player',
...
const reducersSchema = __reducers(
  ...
  __reducerSchema("set_hawk_intent", SetHawkIntentReducer),
